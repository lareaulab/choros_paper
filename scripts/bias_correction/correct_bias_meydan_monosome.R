...
offsets_fname <- file.path(dataset_dir, "Asite_rules_monosomes.txt")
...
min_coverage <- 5
min_nonzero <- 100
regression_model <- formula(count ~ transcript + A + P + E + d5*f5 + f3 + gc) # only 1 d3 length in this dataset
